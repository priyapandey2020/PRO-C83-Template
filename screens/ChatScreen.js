...
export default class ChatScreen extends Component{
 ...
 getAllRequests =()=>{
    ...
    var friend = this.props.navigation.getParam('friend_id')
     console.log("getAllRequests1 "+friend);
    console.log(" getAllRequests1 state"+this.state.friend_id);
     this.setState({friend_id:friend})
    if(friend){
     
      console.log("getAllRequests3 "+friend);
      console.log(" getAllRequests4 state"+this.state.friend_id);
  ...
  sendNotification(){
    ...
    console.log("sendnotification "+friend_id);
